...
p = [0.5, 0.2, 0.7, 0.5, 0.5];

params_to_iterate = {
    3, 'ST angle',    [0.5, 0.7, 0.9];
    4, 'y stretch downslope', [0.1, 0.5, 0.9];
    5, 'x stretch downslope', [0.1, 0.5, 0.9]
};
[n_rows, ~] = size(params_to_iterate);

mode = getsMode.Exp_Spline; % 2, 3
...
sgtitle(sprintf('gets v2 function, mode = %d', mode));
