classdef tmpGeneratorUiAdjuster < handle
    ...
    methods (Access = private)
        ...
        function runComputation(obj)        
            ...
            set(ud.sig_sim, 'XData', 1:length(sig_sim), 'YData', sig_sim);
            set(ud.sig_ref, 'XData', 1:length(sig_ref), 'YData', sig_ref);
        
            set(ud.ecg_ref, 'XData', 1:ud.L, 'YData', sel_ecg12_ref);
            set(ud.ecg_sim, 'XData', 1:ud.L, 'YData', sel_ecg12_sim);
        
            ud.time_marker.Value = ud.qtrtime;
        
            % --- Update correlation coefficients ---
            corr2_global    = obj.getSignalsCorr(ud.BSM_ref, sig_sim_all);
        ...
        function corr = getSignalsCorr(obj, sig1, sig2)
