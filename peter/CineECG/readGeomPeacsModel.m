function DATA = readGeomPeacsModel(dirname,subject,varargin)
...
if exist('wct')
    if exist([modeldir 'all.aedl'])
        AA = 40 * loadmat([modeldir 'all.aedl']);
    elseif exist([modeldir 'all.aedl'])
