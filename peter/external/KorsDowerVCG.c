/*************************** ecgvector.c ******************************************************/
/*                                                                                    
/* KorsDowerVCG \computes the KorsDowerVCG		
/*
...
void showHelp(void)
{
	mexPrintf("KorsDowerVCG, computes the ECG vector loops\n\n");
    mexPrintf("All rights reserved, Copyright Peacs BV, Arnhem 2016\n");
	mexPrintf("SYNTAX\n");
	mexPrintf("[KORSVECTOR,DOWERVECTOR] = KorsDowerVCG(ECG) \n");
    mexPrintf("\n");
