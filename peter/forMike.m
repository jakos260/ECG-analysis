function forMike(subject,GEOM,meas,dirout,varargin)
...
figure(1);clf
% leadv16(GEOM.BSM(1:9,:),'paperspeed',100,'leadsys','12lead','max',[-2.5 2.5])
leadv12cath(GEOM.BSMall(1:9,:),'paperspeed',200,'leadsys','12lead','max',[-2 2],'amplification',4)
saveas(figure(1),fullfile(dirout,ecgname));
