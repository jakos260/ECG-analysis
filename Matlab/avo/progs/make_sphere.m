% make_sphere.m  % identical to icosasub
% generates icosahedron and, if desired, its refinements
% function [VER,ITRI]=make_sphere(nref,mode)
...
%    else,    vertex and triangle indices as found in the refining process    
