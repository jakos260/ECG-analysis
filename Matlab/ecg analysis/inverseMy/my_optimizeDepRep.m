...
TST         = gettres_v_from_TmpLut(INV,opt,keepopt,notchopt,amplopt);                                          % Determine how good the initial input fits the data
...
while 1
    ...
    TST = gettres_v_from_TmpLut(INV,opt,keepopt,notchopt,amplopt);                                              % Determine how good the new input [testopt.tims] fits the data
