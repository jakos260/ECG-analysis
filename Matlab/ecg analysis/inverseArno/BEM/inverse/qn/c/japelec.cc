...
/*  get wilson's electrode positions */
  ...
  assign_el("88", tmp, 0, elec);
  assign_el("89", tmp, 9, elec);
  ...
  contour(pr1, pl1, 1, norm_x,0, norm_y, npnt, pnt, ndhk, dhk,
    &nlmh1, h1, &index);
  elecs(nlmh1, h1, 0, index, npnt, pnt, ndhk, dhk, 10, pos, 1, tmp);
  assign_el("90", tmp, 0, elec);
  assign_el("91", tmp, 9, elec);
  ...
  while (a<1){
    ...
    strcat(s,filename);
    strcat(s," @jap.inp");
    printf("Triplot gebruiken om intercostaalhoogten te bepalen? (j/n)");
    gets(line);
    if (line[0]=='j')
      system(s);
    ...
    fclose(f);
    if (a<3){
      printf("Er zitten %d punten in de file, terwijl er 3 nodig zijn!\n",a);
  ...
  p[0]= 0.0; p[1]= pt[2][1]; p[2]= pt[2][2]+vertshift;
  contour(p, norm_z, 0, norm_x,0, norm_x, npnt, pnt, ndhk, dhk,
      &nlmh1, h1, &index);
  elecs(nlmh1, h1, 0, 30, npnt, pnt, ndhk, dhk, 4, pos, 0, tmp);
  assign_el("92",tmp,0,elec);

/*  get reference points at sternum */
  distance=fabs((pt[1][2]-pt[0][2])/2.0);

  p1[0]= 1.0; p1[1]= 0.0; p1[2]= pt[0][2]+vertshift-2*distance;
  contour(p1, norm_x, 0, norm_y,0, norm_y, npnt, pnt, ndhk, dhk, 
    &nlmh1, h1, &index);
  routlm(pf1,h1[0].tr,h1[0].l,h1[0].m,npnt,pnt,ndhk,dhk);

  p1[0]= 1.0; p1[1]= 0.0; p1[2]= pt[1][2]+vertshift-4*distance;
  contour(p1, norm_x, 0, norm_y,0, norm_y, npnt, pnt, ndhk, dhk, 
    &nlmh1, h1, &index);
...
/*  get reference points at left side */
  ...
  p1[0]=0; p1[1]=1; p1[2]=pt[0][2]+vertshift-2*distance;
  contour(p1, norm_y, 0, norm_x,0, norm_x, npnt, pnt, ndhk, dhk, 
    &nlmh2, h2, &index);
  routlm(pl1,h2[0].tr,h2[0].l,h2[0].m,npnt,pnt,ndhk,dhk);

  p1[0]=0; p1[1]=1; p1[2]=pt[1][2]+vertshift-4*distance;
  contour(p1, norm_y, 0, norm_x,0, norm_x, npnt, pnt, ndhk, dhk, 
    &nlmh2, h2, &index);
...
printf("%7.4f %7.4f %7.4f\n",pr2[0],pr2[1],pr2[2]);
  ...
  assign_el("66",el,3,elec);
  assign_el("65",el,2,elec);
  assign_el("64",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("63",el,0,elec);
  assign_el("62",el,1,elec);
  assign_el("61",el,2,elec);
  assign_el("60",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("73",el,3,elec);
  assign_el("72",el,2,elec);
  assign_el("71",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("70",el,0,elec);
  assign_el("69",el,1,elec);
  assign_el("68",el,2,elec);
  assign_el("67",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("87",el,3,elec);
  assign_el("86",el,2,elec);
  assign_el("85",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("84",el,0,elec);
  assign_el("83",el,1,elec);
  assign_el("82",el,2,elec);
  assign_el("81",el,3,elec);
  ...
  contour(pr1, pf1, 1, norm_x,0, norm_x, npnt, pnt, ndhk, dhk, 
    &nlmh1, h1, &index);
  elecs(nlmh1, h1, 0, index, npnt, pnt, ndhk, dhk, 5, pos, 1, tmp1);

  contour(pr2, pf2, 1, norm_x,0, norm_x, npnt, pnt, ndhk, dhk, 
    &nlmh2, h2, &index);
  elecs(nlmh2, h2, 0, index, npnt, pnt, ndhk, dhk, 5, pos, 1, tmp2);
  ...
  assign_el("3",el,1,elec);
  assign_el("2",el,2,elec);
  assign_el("1",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("12",el,3,elec);
  assign_el("11",el,2,elec);
  assign_el("10",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("9",el,0,elec);
  assign_el("8",el,1,elec);
  assign_el("7",el,2,elec);
  assign_el("6",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("19",el,3,elec);
  assign_el("18",el,2,elec);
  assign_el("17",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("16",el,0,elec);
  assign_el("15",el,1,elec);
  assign_el("14",el,2,elec);
  assign_el("13",el,3,elec);
  ...
  assign_el("25",el,2,elec);
  assign_el("24",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("23",el,0,elec);
  assign_el("22",el,1,elec);
  assign_el("21",el,2,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("33",el,3,elec);
  assign_el("32",el,2,elec);
  assign_el("31",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("30",el,0,elec);
  assign_el("29",el,1,elec);
  assign_el("28",el,2,elec);
  assign_el("27",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("40",el,3,elec);
  assign_el("39",el,2,elec);
  assign_el("38",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("37",el,0,elec);
  assign_el("36",el,1,elec);
  assign_el("35",el,2,elec);
  assign_el("34",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("47",el,3,elec);
  assign_el("46",el,2,elec);
  assign_el("45",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("44",el,0,elec);
  assign_el("43",el,1,elec);
  assign_el("42",el,2,elec);
  assign_el("41",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("54",el,3,elec);
  assign_el("53",el,2,elec);
  assign_el("52",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("51",el,0,elec);
  assign_el("50",el,1,elec);
  assign_el("49",el,2,elec);
  assign_el("48",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("59",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("58",el,0,elec);
  assign_el("57",el,1,elec);
  assign_el("56",el,2,elec);
  assign_el("55",el,3,elec);
