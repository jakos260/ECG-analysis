...
/*
printf("pf1= %8.4f %8.4f %8.4f\n",pf1[0],pf1[1],pf1[2]);
printf("pf2= %8.4f %8.4f %8.4f\n",pf2[0],pf2[1],pf2[2]);
printf("pr1= %8.4f %8.4f %8.4f\n",pr1[0],pr1[1],pr1[2]);
printf("pr2= %8.4f %8.4f %8.4f\n",pr2[0],pr2[1],pr2[2]);
printf("pl1= %8.4f %8.4f %8.4f\n",pl1[0],pl1[1],pl1[2]);
printf("pl2= %8.4f %8.4f %8.4f\n",pl2[0],pl2[1],pl2[2]);
*/
...
*/
  ...
  assign_el("47",el,4,elec);
  assign_el("48",el,6,elec);
  ...
  assign_el("52",el,0,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("53",el,6,elec);
  ...
  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("58",el,1,elec);
  assign_el("59",el,5,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("60",el,2,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("61",el,1,elec);
  assign_el("62",el,6,elec);
  ...
  assign_el("2",el,0,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("3",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("4",el,4,elec);
  assign_el("5",el,2,elec);
  assign_el("6",el,0,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("7",el,2,elec);
  assign_el("8",el,4,elec);
  assign_el("9",el,6,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("10",el,4,elec);
  assign_el("11",el,1,elec);
  assign_el("12",el,0,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("13",el,1,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("16",el,3,elec);
  assign_el("17",el,2,elec);
  ...
  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("25",el,1,elec);
  assign_el("26",el,2,elec);
  assign_el("27",el,4,elec);
