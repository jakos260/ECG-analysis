...
direc= dir('*.bsm');
[VER,ITRI]= loadtri('C:\Users\Peter.Damp2\Documents\Data\geometries\ppd\ppd2\ppd2_thorax65_Nijmegen.tri');
...
%         A=[A; zeros(1,size(A,2))];  
        ...
        figure(1);
        leadv16(lowpassma(A(:,5000:8000),5),'leadsys','nim','max',3,'paperspeed',25)
