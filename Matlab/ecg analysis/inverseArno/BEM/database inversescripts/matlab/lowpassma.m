...
%
% lowpass Moving Average filter over nwin samples, applied to rows of matrix M; 
% finite impulse response; no phase shift
% zero output for frequencies at multiples of f = nwin*sampling_interval
