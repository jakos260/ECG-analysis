...
GEOM.testLeads=loadmat('ppd1.leads');
GEOM.testLeadsrd=loadmat('ppd1rd.leads');
...
% 		if GEOM.Rfreewallver(i)==1 
			GEOM.Rpurkinjever(i)=0;
% 		elseif min(GEOM.DISTsurf(i,GEOM.endoVER==0))<=(maxd)*0.4
% 			GEOM.Rpurkinjever(i)=0;
% 		end
	end			
end
