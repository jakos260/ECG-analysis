function [bestfoci,bestdep,outp]=multifociscan_delta(varargin)
...
sinks=[];
useQRS = 0;
while  nrClust < 1 ||  max(bestdep) > SCAN.qrsduration + 5 
    [SCAN,focusfound,dep,foci,bestshift,cors,rds]=fociscan(GEOM,SCAN,dep,useQRS,cors,rds);
    if ~focusfound
        break;
    end
...
%% =======================================================================
function [SCAN,focusfound,bestdep,foci,bestshift,corsout,rdsout] = fociscan(GEOM,SCAN,initdepIn,useQRS,corsIn,rdsIn)
