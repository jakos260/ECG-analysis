% rotashprexyz.m
% function [NEW,ROT]=rotash(OLD,[phi theta psi],shift, [preshift])
...
% Subsequent translation preshift (when given), rotation phi over x, theta over y' and 
% psi over z'', followed by translation shift.

% 20120821 oostep1. Adapted from rotash 2005-02-24; A. van Oosterom

function [NEW,ROTA]=rotash(OLD,angles,shift,preshift)
...
% global USEZYZ
% if USEZYZ
%     [NEW,ROTA]=rotashpre(OLD,angles,shift,preshift);
%     return
% end
