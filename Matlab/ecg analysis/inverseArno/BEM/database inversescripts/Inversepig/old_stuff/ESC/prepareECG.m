...
SPECS = selectFiducucialPoints(SPECS, BSM,LAY, ECGextra,doAtria);
...
if ~isempty(fileout)
    ...
    extra = 'onsetP onsetQRS endTwave Jpoint ApexT apexU depslope initialSlope plateauSlope repslope repCorrection useCumsum';
...
function SPECS = selectFiducucialPoints(SPECS,ECGIN,LAYIN, ECGextra,doAtria)
% inspect data
ECG = ECGIN;
...
% initial estimates
pinit(1)= 4;     % overall scaling factor T dom
pinit(2)= 0.01;
pinit(3)=-0.03;
pinit(4)= 0.04;
