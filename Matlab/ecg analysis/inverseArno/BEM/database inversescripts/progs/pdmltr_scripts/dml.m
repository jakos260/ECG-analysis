...
% computes the matrix PHI (size: ntri,3) of the contributions of the three distributed monolayers over each of
...
% calling: cross; dots; norm3d; det3d
...
% above:
% vectorized version of the pdmltr_anal.m script, which treats a single
% triangle;
