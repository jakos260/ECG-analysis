% construct adjacency matrix for ECGsim case normal_young_male
...
[heart.LVER,heart.LITRI] = loadtri('lcav.tri'); 
[heart.RVER,heart.RITRI] = loadtri('rcav.tri');
...
save('adj_normalyoungmale.mat','heart')