...
void write_elec(char *filename)
 {
  ...
  strcat(elname[1+2],"*\0");
  strcat(elname[1+6],"*\0");
  strcat(elname[1+13],"*\0");
  strcat(elname[1+20],"*\0");
  strcat(elname[1+27],"*\0");
  strcat(elname[1+34],"*\0");
  strcat(elname[1+41],"*\0");
  strcat(elname[1+48],"*\0");
  strcat(elname[1+55],"*\0");
  strcat(elname[1+62],"*\0");
  strcat(elname[1+69],"*\0");
  strcat(elname[1+73],"*\0");
  strcat(elname[1+77],"*\0");
  strcat(elname[1+84],"*\0");
  strcat(elname[1+91],"*\0");
  strcat(elname[1+99],"*\0");
  strcat(elname[1+107],"*\0");
  strcat(elname[1+115],"*\0");
...
*/
  ...
  assign_el("75",el,0,elec);
  assign_el("76",el,1,elec);
  assign_el("77",el,2,elec);
  assign_el("78",el,3,elec);
  ...
  assign_el("80",el,2,elec);
  assign_el("81",el,1,elec);

  contour(p1, n,0,p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("82",el,0,elec);
  assign_el("83",el,1,elec);
  assign_el("84",el,2,elec);
  assign_el("85",el,3,elec);
  ...
  assign_el("94",el,3,elec);
  assign_el("95",el,2,elec);
  assign_el("96",el,1,elec);

  contour(p1, n,0,p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("97",el,0,elec);
  assign_el("98",el,1,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("101",el,4,elec);
  assign_el("102",el,3,elec);
  assign_el("103",el,2,elec);
  assign_el("104",el,1,elec);

  contour(p1, n,0,p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("105",el,0,elec);
  assign_el("106",el,1,elec);
  assign_el("107",el,2,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("117",el,3,elec);
  assign_el("118",el,2,elec);
  assign_el("119",el,1,elec);

  contour(p1, n,0,p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("120",el,0,elec);
  assign_el("121",el,1,elec);
  assign_el("122",el,2,elec);
  assign_el("123",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("29",el,3,elec);
  assign_el("30",el,2,elec);
  assign_el("31",el,1,elec);

  contour(p1, n,0,p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("32",el,0,elec);
  assign_el("33",el,1,elec);
  assign_el("34",el,2,elec);
  assign_el("35",el,3,elec);
  ...
  assign_el("37",el,2,elec);
  assign_el("38",el,1,elec);

  contour(p1, n,0,p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("39",el,0,elec);
  assign_el("40",el,1,elec);
  assign_el("41",el,2,elec);
  assign_el("42",el,3,elec);
  ...
  assign_el("44",el,2,elec);
  assign_el("45",el,1,elec);

  contour(p1, n,0,p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("46",el,0,elec);
  assign_el("47",el,1,elec);
  assign_el("48",el,2,elec);
  assign_el("49",el,3,elec);
  ...
  assign_el("58",el,2,elec);
  assign_el("59",el,1,elec);

  contour(p1, n,0,p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("60",el,0,elec);
  assign_el("61",el,1,elec);
  assign_el("62",el,2,elec);
  assign_el("63",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("67",el,0,elec);
  assign_el("68",el,1,elec);
  assign_el("69",el,2,elec);
  assign_el("70",el,3,elec);
  ...
  contour(p1, n,0,p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 17, pos2, 0, el);
  assign_el("71",el,0,elec);
  assign_el("72",el,1,elec);
  assign_el("73",el,2,elec);
