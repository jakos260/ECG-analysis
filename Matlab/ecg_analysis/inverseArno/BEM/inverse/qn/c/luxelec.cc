  ...
  /*									*/
  /*	The assignment of electrodes closely resembles the way it is	*/ /*	done by BSM laborants.						*/
  /*									*/
...
/*  get reference points at right side */
  ...
  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("4",el,2,elec);
  assign_el("5",el,6,elec);
  ...
  contour(p1, n,0,p2, 1, norm_z, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("6",el,4,elec);
  assign_el("7",el,1,elec);

  contour(p1, n,0, p2, 1, norm_minz, npnt, pnt, ndhk, dhk, &vnlm, vc, &index);
  elecs(vnlm, vc, 0, 7, npnt, pnt, ndhk, dhk, 7, pos2, 0, el);
  assign_el("8",el,1,elec);
  assign_el("9",el,3,elec);
  ...
  assign_el("15",el,4,elec);
  assign_el("16",el,6,elec);
