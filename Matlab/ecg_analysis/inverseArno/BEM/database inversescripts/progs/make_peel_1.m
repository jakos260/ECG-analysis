...
if nargin>4
   ...
   plot3(VER(lista(1),1),VER(lista(1),2),VER(lista(1),3),'*m', 'linewidth',2)
   plot3(VER(listb(1),1),VER(listb(1),2),VER(listb(1),3),'*m', 'linewidth',2)
end
...
for i=1:na,
      ...
      [mi,j]=min(dist);
      %plot3(VER([lista(i) listb(j)],1),VER([lista(i) listb(j)],2),VER([lista(i) listb(j)],3),'m')
      LINKSa(i,:)=[i j];
end
...
for j=1:nb,
      ...
      [mi,i]=min(dist);
      %plot3(VER([lista(i) listb(j)],1),VER([lista(i) listb(j)],2),VER([lista(i) listb(j)],3),'g')
      LINKSb=[LINKSb;[i j]];
end
