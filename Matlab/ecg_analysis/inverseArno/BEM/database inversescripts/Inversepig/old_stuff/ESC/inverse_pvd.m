...
Splus=getS(INV.T,depopt.tims,repopt.tims,INV.SPECS,notchopt.pot,amplopt.pot+.001,4);
Smin =getS(INV.T,depopt.tims,repopt.tims,INV.SPECS,notchopt.pot,amplopt.pot-.001,4);
...
Splus=getS(INV.T,depopt.tims,repopt.tims,INV.SPECS,notchopt.pot+0.01,amplopt.pot,4);
Smin =getS(INV.T,depopt.tims,repopt.tims,INV.SPECS,notchopt.pot-0.01,amplopt.pot,4);
...
if strcmp(opt.type,'dep')
    Splus=getS(INV.T,opt.tims+1,keepopt.tims,INV.SPECS,notchopt.pot,amplopt.pot,INV.mode);
    Smin =getS(INV.T,opt.tims-1,keepopt.tims,INV.SPECS,notchopt.pot,amplopt.pot,INV.mode);
    startopt=opt;
elseif strcmp(opt.type,'rep')
    Splus=getS(INV.T,keepopt.tims,opt.tims+1,INV.SPECS,notchopt.pot,amplopt.pot,INV.mode);
    Smin =getS(INV.T,keepopt.tims,opt.tims-1,INV.SPECS,notchopt.pot,amplopt.pot,INV.mode);
    startopt=opt;
...
if strcmp(opt.type,'notch')
    S=getS(INV.T,depopt.tims,repopt.tims,INV.SPECS,opt.pot,otheropt.pot,INV.mode);
else %type == ' ampl',
    S=getS(INV.T,depopt.tims,repopt.tims,INV.SPECS,otheropt.pot,opt.pot,INV.mode);
end
...
if strcmp(opt.type,'dep')
    TST.S=getS(INV.T,opt.tims,keepopt.tims,INV.SPECS,notchopt.pot,amplopt.pot,INV.mode);
else %pol=='rep',
    TST.S=getS(INV.T,keepopt.tims,opt.tims,INV.SPECS,notchopt.pot,amplopt.pot,INV.mode);
end
...
function S=getS(T,dep,rep,SPECS,notchpot,scaleAmpl,mode)
...
if mode == 4
    ...
    S=getSmode(T,dep,rep,SPECS,mode);
end