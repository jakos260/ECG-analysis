...
doinit=true; % read init from file
if ~doinit
    skipexisting=false;
end
                        ...
                        if ~skipexisting || length(dir(fullfile(dirout, [fnameout '*.mat'])))<2
                            ...
                            if ~doinv
                                ...
                                if showplots
                                    ...
                                    PSIAinitnohakkel =GEOM.AMA*getSmode(T,measinit.dep,measinit.rep,GEOM.SPECS,4, GEOM);
                                    ...
                                    sigplot(PSIAinit(:,1:GEOM.SPECS.time_Jpoint),'',GEOM.LAY,1.5,'m',1,0);
                                    ...
                                    qtriplot({{'delete *'};{'horizontal 2'};{'vertical 3'};{'funcolor tim'}});
                                    %                             EndoEpiPlot(GEOM,ActInt,'needles',[1,1;2,1],'BOTH');
                                    EndoEpiPlot(GEOM,measinit.dep,'init',[1,2;2,2],'BOTH');
