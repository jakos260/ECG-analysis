...
%     BSM = BSM/1000;
% end
if sampT ~= 1/1000, BSM = resample(BSM,1,size(BSM,2),size(BSM,2)*sampT*1000); end

waitfor( selectBSMbeat(BSM,'lay',LAY,'sampt',1/1000,'zoomfull',zoomfull ) );
...
if nargout >= 1, varargout{1} = BSMOUT;         end
if nargout > 1,  varargout{2} = DATA.remove;    end
