% inverse procedure 
%  Peter van Dam, Peacs November 2010



function [depfinal,repfinal,notchPotfinal,corfinal,rdfinal,iterfinal,RESNOW]=ecginv(GEOM,inittimes,initcase,runcase,usetimes,leads,mode,mudep,murep)
...
if strcmp(GEOM.type,'_atria'),OPT.DEP.mu=1.e-4; end
