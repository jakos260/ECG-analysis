...
%% ========================= TORSO ========================
if exist( [heartpath,'_study12lead.tri'],'file') == 2                       % FIRST, see if there is a study12lead!!
    [GEOM.TVER,GEOM.TITRI] = loadtri([heartpath,'_study12lead.tri']);
elseif exist( [heartpath,'_thorax.tri'],'file') == 2
    ...
    elseif ~isempty(strfind(layfile,'nim')) &&   exist( [heartpath,'_thorax65_Nijmegen.tri'],'file') == 2
    ...
    elseif ~isempty(strfind(layfile,'pig')) && exist( [heartpath,'_thoraxpigs_adam.tri'],'file') == 2
        [GEOM.TVER,GEOM.TITRI] = loadtri([heartpath,'_thoraxpigs_adam.tri']);
    elseif exist( [heartpath,'_study12lead.tri'],'file') == 2
        [GEOM.TVER,GEOM.TITRI] = loadtri([heartpath,'_study12lead.tri']);
    else
...
% select beats if time-signal of bsmfiles is too long. note: selectBSMbeats.m is still in seperate folder [./BEM/selectbeats]!!
...
elseif strcmp(layfile,'nim64.mla')|| strcmp(layfile,'nim65.mla')
    ...
    GEOM.luxA       = [61  6  5 13 15 17 19 20 22 25 26 27 28 29 30 32 34 35 36 38 41 43 44 53 54 55  2 59 58 66 63 ];
