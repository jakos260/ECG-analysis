...
if ~exist('filepath1','var')
    [FileName PathName]=uigetfile('*.mat','Select BSM export file 1','/Users/peteroosterhoff/Documents/Werk/STW/Data/Pig07/Biosemi/export/');
...
if ~exist('filepath2','var')
    [FileName PathName]=uigetfile('*.mat','Select BSM export file 2','/Users/peteroosterhoff/Documents/Werk/STW/Data/Pig07/Biosemi/export/');
    filepath1=fullfile(PathName,FileName);
end
