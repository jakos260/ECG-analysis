...
addpath (append(dir_name, 'ecg_analysis/helpers/CineECG_matlab_scripts'))
...
addpath (append(dir_name, 'ecg_analysis/conferences'))
addpath (append(dir_name, 'ecg_analysis/inverseMy'))
addpath (append(dir_name, 'ecg_analysis/inverseMy/helpers'))
addpath (append(dir_name, 'ecg_analysis/inverseMy/getApLut'))
addpath (append(dir_name, 'ecg_analysis/inverseMy/gettres_v'))
addpath (append(dir_name, 'ecg_analysis/inverseMy/fociscan'))
